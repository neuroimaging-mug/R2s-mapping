function mat_rs = resize_M(varargin)
...
if nargin == 3
    mat_rs = resize_M(varargin{1}, [varargin{2}, varargin{3}]);
else
    mat_rs = resize_M(varargin{1}, [varargin{2}, varargin{3}], varargin{4});
end
return
...
% check inputs
if length(size(mat)) ~= length(varargin{2})
