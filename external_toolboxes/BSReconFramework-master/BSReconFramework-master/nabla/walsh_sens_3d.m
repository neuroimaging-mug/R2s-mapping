function [recon,cmap]=walsh_sens_3d(yn,rn,norm)
...
wsmall=zeros(nc,round(nz./st),round(ny./st),round(nx./st),'single');
cmapsmall=zeros(nc,round(nz./st),round(ny./st),round(nx./st),'single');
